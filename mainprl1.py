...
kxrho   = np.logspace(-7.0,1.0,num) # k_prp*rho_i
plotx = kxrho
...
for j in range(0,2):
  ...
  for i in range(0,num):
    ...
    sol = root(DK.SOLVE,(zeta.real,zeta.imag),args=data,method='hybr',tol=1e-8)
...
fig = plt.gcf()
plt.savefig('kprl2.eps',format='eps',dpi=300,bbox_inches='tight')
plt.show()
